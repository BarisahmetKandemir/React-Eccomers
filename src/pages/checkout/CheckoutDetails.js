...
import { SAVE_BİLLİNG_ADDRESS, SAVE_SHİPPİNG_ADDRESS } from '../../redux/slice/checkoutSlice'
...
const CheckoutDetails = () => {
  ...
  const handleSubmit = (e) => {
    ...
    dispatch(SAVE_SHİPPİNG_ADDRESS(shippingAddress))
    dispatch(SAVE_BİLLİNG_ADDRESS(billingAddress))
    navigate('/checkout')
  }
        ...
        <form onSubmit={handleSubmit}>
          <div>
            <Card cardClass={styles.card}>
              ...
              <input type='text' placeholder='Address Line 2' required name='line2' value={shippingAddress.line2} onChange={(e)=>handleShipping(e)}/>
            ...
            <Card cardClass={styles.card}>
              ...
              <label>Recipient Name</label>
              <input type='text' placeholder='Recipient Name' required name='name' value={billingAddress.name} onChange={(e)=>handleBilling(e)}/>
