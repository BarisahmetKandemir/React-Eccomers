  ...
  reducers: {
    ...
    DECREASE_CART(state, action) {
      ...
      if (state.cartItems[productIndex].cartQuantity > 1) {
        state.cartItems[productIndex].cartQuantity -= 1;
        toast.info(`${action.payload.name} decraesed by one`, { position: "top-left" })
      }
...
export const { ADD_TO_CART, DECREASE_CART, REMOVE_FROM_CART, CLEARE_CART, CALCULATE_SUBTOTAL, CALCULATE_TOTAL_QUANTITY , SAVE_URL } = cartSlice.actions
